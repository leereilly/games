...
* [Khan](https://github.com/topfreegames/khan) - Khan is an HTTP "resty" API for managing clans for games.
...
* [Podium](https://github.com/topfreegames/podium) - A leaderboard backend using Golang and redis
